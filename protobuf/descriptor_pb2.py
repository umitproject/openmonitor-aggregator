...
_FIELDDESCRIPTORPROTO_LABEL = descriptor.EnumDescriptor(
  name='Label',
  full_name='protobuf.FieldDescriptorProto.Label',
  filename=None,
  file=DESCRIPTOR,
  values=[
    descriptor.EnumValueDescriptor(
...
_FILEOPTIONS_OPTIMIZEMODE = descriptor.EnumDescriptor(
  name='OptimizeMode',
  full_name='protobuf.FileOptions.OptimizeMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    descriptor.EnumValueDescriptor(
...
_FIELDOPTIONS_CTYPE = descriptor.EnumDescriptor(
  name='CType',
  full_name='protobuf.FieldOptions.CType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    descriptor.EnumValueDescriptor(
...
_FILEDESCRIPTORSET = descriptor.Descriptor(
  ...
  full_name='protobuf.FileDescriptorSet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='file', full_name='protobuf.FileDescriptorSet.file', index=0,
...
_FILEDESCRIPTORPROTO = descriptor.Descriptor(
  ...
  full_name='protobuf.FileDescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.FileDescriptorProto.name', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='package', full_name='protobuf.FileDescriptorProto.package', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='dependency', full_name='protobuf.FileDescriptorProto.dependency', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='message_type', full_name='protobuf.FileDescriptorProto.message_type', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='enum_type', full_name='protobuf.FileDescriptorProto.enum_type', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='service', full_name='protobuf.FileDescriptorProto.service', index=5,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='extension', full_name='protobuf.FileDescriptorProto.extension', index=6,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='options', full_name='protobuf.FileDescriptorProto.options', index=7,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='source_code_info', full_name='protobuf.FileDescriptorProto.source_code_info', index=8,
...
_DESCRIPTORPROTO_EXTENSIONRANGE = descriptor.Descriptor(
  name='ExtensionRange',
  full_name='protobuf.DescriptorProto.ExtensionRange',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='start', full_name='protobuf.DescriptorProto.ExtensionRange.start', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='end', full_name='protobuf.DescriptorProto.ExtensionRange.end', index=1,
...
_DESCRIPTORPROTO = descriptor.Descriptor(
  ...
  full_name='protobuf.DescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.DescriptorProto.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='field', full_name='protobuf.DescriptorProto.field', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='extension', full_name='protobuf.DescriptorProto.extension', index=2,
      number=6, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='nested_type', full_name='protobuf.DescriptorProto.nested_type', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='enum_type', full_name='protobuf.DescriptorProto.enum_type', index=4,
      number=4, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='extension_range', full_name='protobuf.DescriptorProto.extension_range', index=5,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='options', full_name='protobuf.DescriptorProto.options', index=6,
...
_FIELDDESCRIPTORPROTO = descriptor.Descriptor(
  ...
  full_name='protobuf.FieldDescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.FieldDescriptorProto.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='number', full_name='protobuf.FieldDescriptorProto.number', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='label', full_name='protobuf.FieldDescriptorProto.label', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='type', full_name='protobuf.FieldDescriptorProto.type', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='type_name', full_name='protobuf.FieldDescriptorProto.type_name', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='extendee', full_name='protobuf.FieldDescriptorProto.extendee', index=5,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='default_value', full_name='protobuf.FieldDescriptorProto.default_value', index=6,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='options', full_name='protobuf.FieldDescriptorProto.options', index=7,
      number=8, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ENUMDESCRIPTORPROTO = descriptor.Descriptor(
  ...
  full_name='protobuf.EnumDescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.EnumDescriptorProto.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='value', full_name='protobuf.EnumDescriptorProto.value', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='options', full_name='protobuf.EnumDescriptorProto.options', index=2,
...
_ENUMVALUEDESCRIPTORPROTO = descriptor.Descriptor(
  ...
  full_name='protobuf.EnumValueDescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.EnumValueDescriptorProto.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='number', full_name='protobuf.EnumValueDescriptorProto.number', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='options', full_name='protobuf.EnumValueDescriptorProto.options', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SERVICEDESCRIPTORPROTO = descriptor.Descriptor(
  ...
  full_name='protobuf.ServiceDescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.ServiceDescriptorProto.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='method', full_name='protobuf.ServiceDescriptorProto.method', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='options', full_name='protobuf.ServiceDescriptorProto.options', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METHODDESCRIPTORPROTO = descriptor.Descriptor(
  ...
  full_name='protobuf.MethodDescriptorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.MethodDescriptorProto.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='input_type', full_name='protobuf.MethodDescriptorProto.input_type', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='output_type', full_name='protobuf.MethodDescriptorProto.output_type', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='options', full_name='protobuf.MethodDescriptorProto.options', index=3,
...
_FILEOPTIONS = descriptor.Descriptor(
  name='FileOptions',
  full_name='protobuf.FileOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='java_package', full_name='protobuf.FileOptions.java_package', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='java_outer_classname', full_name='protobuf.FileOptions.java_outer_classname', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='java_multiple_files', full_name='protobuf.FileOptions.java_multiple_files', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='java_generate_equals_and_hash', full_name='protobuf.FileOptions.java_generate_equals_and_hash', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='optimize_for', full_name='protobuf.FileOptions.optimize_for', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='cc_generic_services', full_name='protobuf.FileOptions.cc_generic_services', index=5,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='java_generic_services', full_name='protobuf.FileOptions.java_generic_services', index=6,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='py_generic_services', full_name='protobuf.FileOptions.py_generic_services', index=7,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='protobuf.FileOptions.uninterpreted_option', index=8,
...
_MESSAGEOPTIONS = descriptor.Descriptor(
  name='MessageOptions',
  full_name='protobuf.MessageOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='message_set_wire_format', full_name='protobuf.MessageOptions.message_set_wire_format', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='no_standard_descriptor_accessor', full_name='protobuf.MessageOptions.no_standard_descriptor_accessor', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='protobuf.MessageOptions.uninterpreted_option', index=2,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FIELDOPTIONS = descriptor.Descriptor(
  name='FieldOptions',
  full_name='protobuf.FieldOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='ctype', full_name='protobuf.FieldOptions.ctype', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='packed', full_name='protobuf.FieldOptions.packed', index=1,
      number=2, type=8, cpp_type=7, label=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='deprecated', full_name='protobuf.FieldOptions.deprecated', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='experimental_map_key', full_name='protobuf.FieldOptions.experimental_map_key', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='protobuf.FieldOptions.uninterpreted_option', index=4,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ENUMOPTIONS = descriptor.Descriptor(
  name='EnumOptions',
  full_name='protobuf.EnumOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='protobuf.EnumOptions.uninterpreted_option', index=0,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ENUMVALUEOPTIONS = descriptor.Descriptor(
  ...
  full_name='protobuf.EnumValueOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='protobuf.EnumValueOptions.uninterpreted_option', index=0,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SERVICEOPTIONS = descriptor.Descriptor(
  name='ServiceOptions',
  full_name='protobuf.ServiceOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='protobuf.ServiceOptions.uninterpreted_option', index=0,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_METHODOPTIONS = descriptor.Descriptor(
  name='MethodOptions',
  full_name='protobuf.MethodOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='uninterpreted_option', full_name='protobuf.MethodOptions.uninterpreted_option', index=0,
      number=999, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UNINTERPRETEDOPTION_NAMEPART = descriptor.Descriptor(
  name='NamePart',
  full_name='protobuf.UninterpretedOption.NamePart',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name_part', full_name='protobuf.UninterpretedOption.NamePart.name_part', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='is_extension', full_name='protobuf.UninterpretedOption.NamePart.is_extension', index=1,
...
_UNINTERPRETEDOPTION = descriptor.Descriptor(
  ...
  full_name='protobuf.UninterpretedOption',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='name', full_name='protobuf.UninterpretedOption.name', index=0,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='identifier_value', full_name='protobuf.UninterpretedOption.identifier_value', index=1,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    descriptor.FieldDescriptor(
      name='positive_int_value', full_name='protobuf.UninterpretedOption.positive_int_value', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='negative_int_value', full_name='protobuf.UninterpretedOption.negative_int_value', index=3,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='double_value', full_name='protobuf.UninterpretedOption.double_value', index=4,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='string_value', full_name='protobuf.UninterpretedOption.string_value', index=5,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='aggregate_value', full_name='protobuf.UninterpretedOption.aggregate_value', index=6,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SOURCECODEINFO_LOCATION = descriptor.Descriptor(
  name='Location',
  full_name='protobuf.SourceCodeInfo.Location',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='path', full_name='protobuf.SourceCodeInfo.Location.path', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='span', full_name='protobuf.SourceCodeInfo.Location.span', index=1,
...
_SOURCECODEINFO = descriptor.Descriptor(
  name='SourceCodeInfo',
  full_name='protobuf.SourceCodeInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='location', full_name='protobuf.SourceCodeInfo.location', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
class FileDescriptorSet(message.Message):
  ...
  # @@protoc_insertion_point(class_scope:protobuf.FileDescriptorSet)

class FileDescriptorProto(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _FILEDESCRIPTORPROTO
  
  # @@protoc_insertion_point(class_scope:protobuf.FileDescriptorProto)
...
class DescriptorProto(message.Message):
  ...
  class ExtensionRange(message.Message):
    ...
    # @@protoc_insertion_point(class_scope:protobuf.DescriptorProto.ExtensionRange)
  DESCRIPTOR = _DESCRIPTORPROTO
  
  # @@protoc_insertion_point(class_scope:protobuf.DescriptorProto)

class FieldDescriptorProto(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _FIELDDESCRIPTORPROTO
  
  # @@protoc_insertion_point(class_scope:protobuf.FieldDescriptorProto)

class EnumDescriptorProto(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ENUMDESCRIPTORPROTO
  
  # @@protoc_insertion_point(class_scope:protobuf.EnumDescriptorProto)

class EnumValueDescriptorProto(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ENUMVALUEDESCRIPTORPROTO
  
  # @@protoc_insertion_point(class_scope:protobuf.EnumValueDescriptorProto)

class ServiceDescriptorProto(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _SERVICEDESCRIPTORPROTO
  
  # @@protoc_insertion_point(class_scope:protobuf.ServiceDescriptorProto)

class MethodDescriptorProto(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _METHODDESCRIPTORPROTO
  
  # @@protoc_insertion_point(class_scope:protobuf.MethodDescriptorProto)

class FileOptions(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _FILEOPTIONS
  
  # @@protoc_insertion_point(class_scope:protobuf.FileOptions)

class MessageOptions(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _MESSAGEOPTIONS
  
  # @@protoc_insertion_point(class_scope:protobuf.MessageOptions)

class FieldOptions(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _FIELDOPTIONS
  
  # @@protoc_insertion_point(class_scope:protobuf.FieldOptions)

class EnumOptions(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ENUMOPTIONS
  
  # @@protoc_insertion_point(class_scope:protobuf.EnumOptions)

class EnumValueOptions(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _ENUMVALUEOPTIONS
  
  # @@protoc_insertion_point(class_scope:protobuf.EnumValueOptions)

class ServiceOptions(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _SERVICEOPTIONS
  
  # @@protoc_insertion_point(class_scope:protobuf.ServiceOptions)

class MethodOptions(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _METHODOPTIONS
  
  # @@protoc_insertion_point(class_scope:protobuf.MethodOptions)
...
class UninterpretedOption(message.Message):
  ...
  class NamePart(message.Message):
    ...
    # @@protoc_insertion_point(class_scope:protobuf.UninterpretedOption.NamePart)
  DESCRIPTOR = _UNINTERPRETEDOPTION
  
  # @@protoc_insertion_point(class_scope:protobuf.UninterpretedOption)
...
class SourceCodeInfo(message.Message):
  ...
  class Location(message.Message):
    ...
    # @@protoc_insertion_point(class_scope:protobuf.SourceCodeInfo.Location)
  DESCRIPTOR = _SOURCECODEINFO
  
  # @@protoc_insertion_point(class_scope:protobuf.SourceCodeInfo)
